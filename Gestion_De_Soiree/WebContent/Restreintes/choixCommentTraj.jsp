...
<body>
   <form  method="get" action="../commenterTraj" >

	</br>
	<h1 style="text-align:center; background-color:#cccccc;"> Quel trajet souhaitez vous Commenter </h1>
	</br>
	<center>
                        ...
                        <%ArrayList<String> trajet = new ArrayList<String>();
							 ...
							 // JDBC driver name and database URL
							   ...
							   try{
							      ...
							      String sql;
							      sql = "SELECT  NUMERO_TRAJET from INSCRIPTION where NUMERO_TRAJET in (select IF(TIMESTAMP(DATE_DEPART+7)<=now(), NUMERO_TRAJET,'') from TRAJET)and NUMERO_ETUDIANT="+numEt+" ;";
