...
<body>            
	<form method="get" action="../suppression">
        ...
        <div>
                <fieldset>
                    	<h1 style="text-align:center; background-color:red;"> Supprimer Trajet </h1>
                
                	</br>
    				<p> Vous ne pouvez supprimer que les trajets dans lesquels vous etes seul inscrit </p>
    				</br>
                    <label for="supp">Choisissez le trajet que vous souhaitez supprimer</label>
						  ...
						  <%ArrayList<String> trajet = new ArrayList<String>();
							 ...
							 // JDBC driver name and database URL
							   ...
							   try{
							      ...
							      String sql;
							      sql = "SELECT NUMERO_TRAJET, count(NUMERO_ETUDIANT) from INSCRIPTION where NUMERO_TRAJET in ( select NUMERO_TRAJET from TRAJET where NUMERO_CREATEUR="+numEt+") group by NUMERO_TRAJET having count(NUMERO_ETUDIANT)=1;";
