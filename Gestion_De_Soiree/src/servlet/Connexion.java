		  ...
		  /*
	        ...
	        String pass = request.getParameter( "psw" );
	 	      ...
	 	      stmt = conn.createStatement();
	        	   ...
	        	   if ( pseudo != null ) {
				      ResultSet rs = stmt.executeQuery("select * from NEW where PSEUDO = '"+pseudo+"' and PASS=MD5('"+pass+"');");
				     System.out.println("iiiiiiiiiiiiifffffffffffff");
				      String chp;
				      if ( rs.next() == false ){//
					     
						    		  message = "Pseudo ou Mot De Pass Erroné ";
						    		  System.out.println("Pseudo ou Mot de passe Errone");
